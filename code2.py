...
class MyHttpRequestHandler(http.server.SimpleHTTPRequestHandler):
    def do_GET(self):
        ...
        self.wfile.write(bytes("<body><h1>Hello, pakistan is the best country </h1></body></html>", "utf-8"))
        return
...
if __name__ == "__main__":
    ...
    command = "echo Hello, pakistan is the best country"
